	...
	<div id="wrap">
		...
		?>
			...
			<?
				...
				{
			?>
							<div>HTML 쓰기<input type="checkbox" name="html_ok" value="y"></div>
			<?
				}
			?>		
						</div>
						...
						<div class="write_file">
							<ul>
								<li>
									<label for="fileDown1">파일 첨부</label>
									<input type="file"  name="upfile[]" class="hidden" id="fileDown1" onchange="javascript:document.getElementById('fileName1').value = this.value.split('\\')[this.value.split('\\').length-1]">
									<input type="text" id="fileName1" class="file_input_textbox" readonly="readonly" placeholder="선택된 파일이 없습니다.">
			<? 	if ($mode=="modify" && $item_file_0)
				{
			?>
									<div class="delete_ok"><?=$item_file_0?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="0"> <span>삭제하기</span></div>
			<?
				}
			?>
								</li>
								<li>
									<label for="fileDown2">파일 첨부</label>
									<input type="file"  name="upfile[]" class="hidden" id="fileDown2" onchange="javascript:document.getElementById('fileName2').value = this.value.split('\\')[this.value.split('\\').length-1]">
									<input type="text" id="fileName2" class="file_input_textbox" readonly="readonly" placeholder="선택된 파일이 없습니다.">
			<? 	if ($mode=="modify" && $item_file_1)
				{
			?>
									<div class="delete_ok"><?=$item_file_1?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="1"> <span>삭제하기</span></div>
			<?
				}
			?>
								</li>
								<li>
									<label for="fileDown3">파일 첨부</label>
									<input type="file"  name="upfile[]" class="hidden" id="fileDown3" onchange="javascript:document.getElementById('fileName3').value = this.value.split('\\')[this.value.split('\\').length-1]">
									<input type="text" id="fileName3" class="file_input_textbox" readonly="readonly" placeholder="선택된 파일이 없습니다.">
			<? 	if ($mode=="modify" && $item_file_2)
				{
			?>
									<div class="delete_ok"><?=$item_file_2?> 파일이 등록되어 있습니다. <input type="checkbox" name="del_file[]" value="2"> <span>삭제하기</span></div>
			<?
				}
			?>
								</li>
					...
					<div class="write_button">
						<a href="list.php?table=<?=$table?>&page=<?=$page?>">취소</a>
